    ...
    useEffect(function () {
        if (thisfirebaseConfig) {
            ...
            if (avatar === null || avatar === void 0 ? void 0 : avatar.userId)
                checkIfUserOnline(avatar === null || avatar === void 0 ? void 0 : avatar.userId, setIsOnline, isOnline);
            if (avatar === null || avatar === void 0 ? void 0 : avatar.userId) {
                console.log("avatar uiser is:", avatar === null || avatar === void 0 ? void 0 : avatar.userId);
            }
            else {
